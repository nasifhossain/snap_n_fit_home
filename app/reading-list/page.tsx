        ...
        <div className="min-h-screen bg-[var(--background)]">
          ...
          <div className="max-w-6xl mx-auto px-6 py-12">
            <div className="animate-pulse">
              ...
              <div className="bg-white rounded-2xl p-8 mb-8 shadow-sm border border-[var(--card-border)]">
        ...
        <div className="min-h-screen bg-[var(--background)]">
          ...
          <div className="text-center">
            ...
            <button 
              ...
              className="px-6 py-3 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-hover)] transition-colors duration-[var(--animation-fast)]"
            >
              Retry
            </button>
          </div>
      ...
      <div className="min-h-screen bg-[var(--background)]">
        ...
        <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="mb-12">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-[var(--card-border)] mb-12">
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    <div className="text-center p-4 bg-[var(--secondary-light)] rounded-xl">
                    ...
                    <div className="text-center p-4 bg-[var(--status-completed-bg)] rounded-xl">
                      <div className="text-3xl font-bold text-[var(--status-completed)] mb-1">
                        {stats.booksRead}
                      </div>
                      <div className="text-sm text-[var(--text-secondary)] font-medium">
                        Books Read
                    ...
                    <div className="text-center p-4 bg-[var(--status-active-bg)] rounded-xl">
                      <div className="text-3xl font-bold text-[var(--status-active)] mb-1">
                        {stats.completion}%
                      </div>
                      <div className="text-sm text-[var(--text-secondary)] font-medium">
                        Completion
          ...
          <div>
            ...
            {books.length === 0 ? (
              <div className="bg-white rounded-2xl p-16 text-center shadow-sm border border-[var(--card-border)]">
                <div className="w-16 h-16 bg-[var(--secondary-light)] rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-[var(--card-border)] overflow-hidden">
                        ...
                        >
                          ...
                          <td className="px-6 py-6">
                            <div className="flex items-center gap-2">
                              <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[var(--primary-light)] text-[var(--primary)]">
                          ...
                          <td className="px-6 py-6">
                            <button
                              ...
                              className={`inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium transition-all duration-[var(--animation-fast)] ${
                                book.userStatus === 'read'
